...
public class DetailMovieActivity extends AppCompatActivity {
    ...
    private void setMovieData(){
        ...
        Glide.with(this)
                ...
                .placeholder(io.github.nikkoes.katalogfilm.R.drawable.no_image_icon)
                .into(imageBackdrop);
        txtNamaMovie.setText(title);
        txtTanggalMovie.setText(releaseDate);
        txtDeskripsiMovie.setText(overview);
        btnFavorite.setImageResource(io.github.nikkoes.katalogfilm.R.drawable.ic_star_unchecked);
    }
